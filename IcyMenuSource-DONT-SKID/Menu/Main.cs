    ...
    public class Main : MonoBehaviour
    {
                        ...
                        else
                        {
                            if (!Settings.MenuPhysics)
                            {
                                if (menu != null)
                                {
                                    ...
                                    UnityEngine.Object.Destroy(reference, 2);
                                    reference = null;
                                }
                            }
                            else
                            {
                                ...
                                if (rightHanded)
                                {
                                    ...
                                    comp.mass = 0.5f;
                                    comp.drag = 0.1f;
                                    comp.angularDrag = 0.01f;
                                    comp.AddTorque(new Vector3(14f, 15f, 14f));
                                    comp.AddTorque(UnityEngine.Random.insideUnitSphere * 7777f);
        ...
        public static void CreateMenu()
        {
            ...
            // Title and FPS
                ...
                text.text = PluginInfo.Name + " <color=purple>[</color><color=grey>" + (pageNumber + 1).ToString() + "</color><color=purple>]</color>";
                ...
                component.sizeDelta = new Vector2(0.24f, 0.04f); // 0.28f, 0.05f
            ...
            if (disconnectButton)
                    {
                        ...
                        disconnectbutton.transform.localScale = new Vector3(0.09f, 0.4f, 0.08f); // 0.09f, 0.9f, 0.08f
            ...
            if (PanicButton)
            {
                GameObject panicbutton = GameObject.CreatePrimitive(PrimitiveType.Cube);
                if (!UnityInput.Current.GetKey(KeyCode.Q))
                {
                    panicbutton.layer = 2;
                }
                UnityEngine.Object.Destroy(panicbutton.GetComponent<Rigidbody>());
                panicbutton.GetComponent<BoxCollider>().isTrigger = true;
                panicbutton.transform.parent = menu.transform;
                panicbutton.transform.rotation = Quaternion.identity;
                panicbutton.transform.localScale = new Vector3(0.09f, 0.1f, 0.6f); // 0.09f, 0.9f, 0.08f
                panicbutton.transform.localPosition = new Vector3(0.56f, -0.50f, 0);
                panicbutton.GetComponent<Renderer>().material.color = buttonColors[0].colors[0].color;
                panicbutton.AddComponent<Classes.Button>().relatedText = "Panic";

                colorChanger = panicbutton.AddComponent<ColorChanger>();
                colorChanger.colorInfo = buttonColors[0];
                colorChanger.Start();

                Text panictext = new GameObject
                {
                    transform =
                            {
                                parent = canvasObject.transform
                ...
                panictext.text = "Panic";
                panictext.font = currentFont;
                panictext.fontSize = 1;
                panictext.color = textColors[0];
                panictext.alignment = TextAnchor.MiddleCenter;
                panictext.resizeTextForBestFit = true;
                panictext.resizeTextMinSize = 0;

                RectTransform rectt = panictext.GetComponent<RectTransform>();
                rectt.localPosition = Vector3.zero;
                rectt.sizeDelta = new Vector2(0.2f, 0.03f);
                rectt.localPosition = new Vector3(0.064f, -0.150f, 0f);
                rectt.rotation = Quaternion.Euler(new Vector3(180f, 90f, 0f));
            }
            ...
            if (homeButton)
            {
                ...
                homebutton.transform.localScale = new Vector3(0.09f, 0.7f, 0.07f); // 0.09f, 0.9f, 0.08f
                homebutton.transform.localPosition = new Vector3(0.56f, 0f, -0.55f);
            ...
            // Page Buttons
             ...
             gameObject.transform.localScale = new Vector3(0.09f, 0.14f, 0.06f);
             gameObject.transform.localPosition = new Vector3(0.56f, 0.33f, 0.53f);
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.transform.parent = menu.transform;
            gameObject.transform.rotation = Quaternion.identity;
            gameObject.transform.localScale = new Vector3(0.09f, 0.75f, 0.075f); // 0.09f, 0.9f, 0.08f
            gameObject.transform.localPosition = new Vector3(0.56f, 0f, 0.293f - offset);
            ...
            RectTransform component = text.GetComponent<RectTransform>();
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(.2f, .02f); // .2f, .03f
            component.localPosition = new Vector3(.064f, 0, .115f - offset / 2.6f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        }
        ...
        public static void CreateReference(bool isRightHanded)
        {
            ...
            reference.GetComponent<Renderer>().material.shader = Shader.Find("GUI/Text Shader");
